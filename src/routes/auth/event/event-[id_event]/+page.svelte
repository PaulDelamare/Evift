...
<PageLayout>
	<section slot="hero" class="bg-gradient py-12">
		<div class="wrap flex flex-col">
			<div class=" flex items-center justify-center gap-8 text-surface-500">
				...
				<div class="min-w-80 flex flex-col gap-2">
			...
			<button
				...
				class="bg-surface-500 self-end rounded-lg flex items-center gap-4 py-2 px-3 text-secondary-500 uppercase font-bold hover:scale-[1.02] custom-transition active:scale-90"
			>
				<div class="w-4">
	...
	<section>
		<div class=" wrap gap-8 grid grid-cols-[repeat(auto-fit,_minmax(360px,_1fr))] px-4">
			<div
