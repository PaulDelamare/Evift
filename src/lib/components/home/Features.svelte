    ...
    const features = [
        {
            ...
            description: 'Crée ton événement et ajoutes-y ta famille ou tes amis. Il ne te restera plus qu’à utiliser les outils pour le gérer avec toute simplicité.',
            img: '/svg/home/features/add.svg'
            
        },
        {
            title: 'Rejoins un événement',
            description: 'Accepte l’invitation que tu as reçue pour participer à un événement pour accéder à toutes les informations de celui-ci.',
            img: '/svg/home/features/join.svg'

        },
        {
            title: 'Gère ta liste de cadeaux',
            description: 'Crée ta liste de cadeaux pour que les autres membres de l’événement puissent accéder à celle-ci pour recevoir une belle surprise !',
