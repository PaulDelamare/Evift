...
<div class="middle-wrap py-12 column gap-12 px-8">
    ...
    <!-- Bloc for Copyright text -->
    <div>
        <!-- text with Link for going on Legal page -->
        <p class="text-surface-500 text-center tablet:text-sm">© 2024 Evift. Tous droits réservés. <a href="/">Mentions Légales</a> | <a href="/">Conditions Générales d'Utilisation</a> | <a href="/">Politique de Confidentialité</a></p>
    </div>
</div>
